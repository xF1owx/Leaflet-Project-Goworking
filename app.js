...
// Generation layer Map //
var map = L.map('map', {
    zoom: 12,
    layers: [points] // Ajout du layer pour les points //
}).setView([47.234415, 5.9238639999999805], 8);
L.tileLayer('https://korona.geog.uni-heidelberg.de/tiles/roads/x={x}&y={y}&z={z}', {
    maxZoom: 20
}).addTo(map);

map.addLayer(points); // Ajout du layer pour les points //
...
// RECENTRAGE SUR POS USER OU VILLE PRECEDEMMENT SELECTIONNERE //
